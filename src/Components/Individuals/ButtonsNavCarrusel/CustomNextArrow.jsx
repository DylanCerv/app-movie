...
export default function CustomNextArrow(props) {
  ...
  return (
    <button className='nextArrow' onClick={onClick}>
        <svg width="24" height="24" xmlns="http://www.w3.org/2000/svg" className="ipc-icon ipc-icon--chevron-right-inline ipc-icon--inline ipc-pager-icon" id="iconContext-chevron-right-inline" viewBox="0 0 24 24" fill="currentColor" role="presentation">
