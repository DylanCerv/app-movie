    ...
    <header className='header flex flex-row justify-between gap-5 px-10'>
        <div className='flex items-center gap-2 md:gap-10 md:pl-10 lg:gap-5'>
          <div className='hamburger cursor-pointer md:hidden'>
            <svg className='w-20' xmlns="http://www.w3.org/2000/svg" width="50" height="50" class="ipc-icon ipc-icon--menu ipc-responsive-button__icon" id="iconContext-menu" viewBox="0 0 24 24" fill="currentColor" role="presentation">
